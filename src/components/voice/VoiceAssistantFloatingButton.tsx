...
export const VoiceAssistantFloatingButton: React.FC<VoiceAssistantFloatingButtonProps> = ({
  ...
  return (
    <Button 
      ...
      className="fixed bottom-6 right-6 rounded-full shadow-lg w-16 h-16 z-[9999] bg-gradient-to-br from-purple-500 to-purple-700 hover:from-purple-600 hover:to-purple-800 transition-all duration-300 border-2 border-purple-300/20 backdrop-blur-sm"
      size="icon"
      variant="default"
    ...
    >
      <div className="relative flex items-center justify-center w-full h-full">
        ...
        <div className="bg-white/20 rounded-full p-2.5 backdrop-blur-sm">
          <Mic size={22} className="text-white filter drop-shadow-md" />
        </div>
        {isListening && (
